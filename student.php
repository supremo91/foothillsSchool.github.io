            ...
            <div class="card shadow">
                <div class="row">
                    <div class="bg-primary text-white">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" id="student-search" class="form-control" placeholder="Search by Student Name, Admission Date or Class">
                            </div>
                        </div>
                    ...
                    <table class="table table-bordered table-striped" id="myTable">
                        ...
                        <tbody id="student-table-body-placeholder">
                            ...
                            ?>
                                ...
                                <td><img src="uploads/<?= $student['Student_Picture']; ?>" alt="<?= $student['Student_Name'] . "'s Picture"; ?>" width="80" height="80"></td>
                                <td><img src="uploads/<?= $student['Parent_Picture']; ?>" alt="<?= $student['Father_Name'] . "'s Picture"; ?>" width="80" height="80"> </td>
                                <td>
