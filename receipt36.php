                ...
                <div class="col-md-12 text-end">
                       ...
                       <!-- <a href="student.php" class="btn btn-primary btn-sm">Enrollment</a> -->
                        ...
                        <a href="home.html" class="btn btn-secondary btn-sm">Click To Home</a>
                         <input type="text" id="receipt-search" class="form-control" placeholder="Search by Name">
                    </div>
                </div> 
               ...
               <div class="row">
                 <div class="col-sm-6">
                        <?php if ($dailyTotalFees > 0): ?>
                            <h4>Fees Paid on <?php echo date('l'); ?> GHC <?php echo $dailyTotalFees; ?> </h4>
                        <?php else: ?>
                ...
                <div class="col-sm-5">
                    <?php if ($totalFees > 0): ?>
                    <h4>Total Fees Paid GHC <?php echo $totalFees; ?> </h4>
                    <?php else: ?>
                    <h4>No record for today</h4>
                    <?php endif; ?>
                </div>
